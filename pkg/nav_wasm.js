 ...
 * @param {string} to_id
 * @param {boolean} avoid_hills
 * @returns {any}
 */
export function route(from_id, to_id, avoid_hills) {
    ...
    const ret = wasm.route(ptr0, len0, ptr1, len1, avoid_hills);
    return ret;
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('nav_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
